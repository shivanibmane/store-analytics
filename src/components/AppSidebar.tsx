...
const sidebarMenu = [
  ...
  { id: 3, name: "Entry/Exit Analytics", icon: <IoAnalyticsOutline />, path: "/entry-exit-analytics" },
  { id: 4, name: "Intrusion Analysis", icon: <FaRegChartBar />, path: "/intrusion-analysis" },
  { id: 5, name: "Unavailable Employee", icon: <FaChartLine />, path: "/unavailable-employee" },
  { id: 6, name: "Mobile Usage", icon: <MdOutlinePhoneIphone />, path: "/mobile-usage" },
]
